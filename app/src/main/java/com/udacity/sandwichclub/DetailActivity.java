...
public class DetailActivity extends AppCompatActivity {
    ...
    private TextView description, placeOfOrigin, alsoKnownAs, ingredients;
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        placeOfOrigin = findViewById(R.id.detail_origin_tv);
        alsoKnownAs = findViewById(R.id.detail_also_known_tv);
